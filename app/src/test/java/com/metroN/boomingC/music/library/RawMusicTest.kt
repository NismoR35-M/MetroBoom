...
import org.metroN.boomingC.music.MusicMode
...
class RawMusicTest {
    ...
    fun musicUid_auxio() {
        ...
        assertEquals(
            "metroN.metroN.boomingC:a10b-3d29c202-cd52-fbe0-4714-47cd07f07a59", uid.toString())
    }
    ...
    fun musicUid_musicBrainz() {
        ...
        assertEquals("metroN.musicbrainz:a10a-9b3b0695-0cdc-4560-8486-8deadee136cb", uid.toString())
    }
